	...
	<div class="container">
		...
		<?php include("inc/sticky-header.php"); ?>
			...
			<div class="col-sm-8 my-account-main-wrap">
				...
				<h2 class="mypersonaldetails-h2"><span class="allvalue-red">My</span> Personal Details</h2>
				...
				<table class="infotable">
					...
					<h3>Email Address and Password</h3>
		
					<table class="infotable">
						<tr>
							<td><strong>Email Address:</strong></td>
								<td>johncruz@yahoo.com</td>
								<td class="info-edit"><a href="#"><i class="fas fa-pencil-alt"></i> Edit</a></td>
				
						</tr>
						<tr>
							<td><strong>Password:</strong></td>
							<td >Last Updated: 4/04/2017</td>
									<td class="info-edit"> <a href="#"><i class="fas fa-pencil-alt"></i> Edit</a></td>
					...
					<option>Php 500,000 and above</option>
						...
						<option>7 or more</option>
						  ...
						  <div class="terms-conditions-scroll">
				 		   ...
				 		   <input type="submit" class="submit-but" value="Save Changes">
