<?php 
	...
	if(isset($_SESSION['account_id']) && $_SESSION['account_id'] != '') {	
		$access = accessDao::accessPage($_SESSION['account_id'], 13);
...
<head>
	<title>AllRewards cPanel | Add New Inquiry Recipient</title> 
		...
		<section id="main-body-section">
			...
			<div id="content-container">
				...
				<div class="section group col span_2_of_2">
					...
					<form id="recipientForm" enctype="multipart/form-data" class="formular" name="example1" method="post" action="../controller/controller.recipients.php?action=add_recipient">

						<div class="span-content-header">
							<h1>Add New E-mail Recipient</h1>
							...
							<table>
								...
								<tr>
									<td>
										...
										<input name="recipient_name" id="recipient_name" type="text" placeholder="Juan Dela Cruz" tabindex="1"
											data-sanitize="trim"
								...
								<tr>
									<td>
										...
										<input name="recipient_email" id="recipient_email" type="email" placeholder="juan.delacruz@allrewards.com.ph" tabindex="2"
											data-sanitize="trim"
						...
						<div class="span-content-footer">
							<button class="cms-btn btn" tabindex="3">Add</button>
