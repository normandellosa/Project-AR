<?php 
	...
	if (isset($_SESSION['account_id']) && $_SESSION['account_id'] != '') {	
		$access = accessDao::accessPage($_SESSION['account_id'], 5);
...
<head>
	<title>AllRewards cPanel | Add New Reward</title> 
		...
		<section id="main-body-section">
			...
			<div id="content-container">
				...
				<div class="section group col span_2_of_2">
					...
					<form id="rewardForm" enctype="multipart/form-data" class="formular" name="example1" method="post" action="../controller/controller.rewards.php?action=add_rewards">
							...
							<table>
								...
								<tr>
									<td>
										...
										<select id="rno_category_fk" name="rno_category_fk" tabindex="1" required="required">
								...
								<tr>
									<td>
										...
										<input name="rno_title" id="rno_title" type="text" placeholder="Get % Off / Save Pesos" tabindex="2"
											data-sanitize="trim"
								...
								<tr>
									<td>
										<textarea name="rno_subtitle" id="rno_subtitle" col="26" row="3" class="text-input" tabindex="3" data-sanitize="trim" data-validation="required"></textarea>
									</td>
								</tr>
								...
								<tr class="no-divider">
									...
									<td class="date-input">
										...
										<input name="rno_date_start" id="rno_date_start" type="text" class="datepicker" placeholder="YYYY-MM-DD" tabindex="4"
									...
									<td class="date-input">
										...
										<input name="rno_date_end" id="rno_date_end" type="text" class="datepicker" placeholder="YYYY-MM-DD" tabindex="5"
											data-validation="date"
											data-validation-optional="true" />
									</td>
								</tr>
								...
								<tr>
									<td>
										<textarea name="rno_details" id="rno_details" col="26" row="3" class="text-input" tabindex="6"></textarea>
									</td>
								</tr>
								...
								<tr>
									<td>
										...
										<input type="file" name="rno_image" id="rno_image" size="40" tabindex="7"
